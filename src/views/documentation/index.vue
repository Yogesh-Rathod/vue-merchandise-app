<template>
  <div class="app-container documentation-container">
    <a class="document-btn" target='_blank' href="https://panjiachen.github.io/-site/#/">{{$t('documentation.documentation')}}</a>
    <a class="document-btn" target='_blank' href="https://github.com/PanJiaChen//">{{$t('documentation.github')}}</a>
